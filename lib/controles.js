...
(function(){
  ...
  // No celular/touch inicia aberto; no desktop inicia recolhido se desejar
  ...
  style.textContent = `
    ...
    /* Ocultar enquanto a tela de início (#start) estiver ativa para não tapar o botão Começar */
    #virtualControls.start-hidden {
  ...
  toggleBtn.addEventListener("click", (e) => {
    ...
    document.body.classList.toggle("vc-collapsed", isCollapsed);
    toggleBtn.textContent = isCollapsed ? "⌃ Teclado / Controle" : "⌄ Ocultar";
  });

  /* Gerenciamento de visibilidade durante a tela de início (#start) */
  function checkStartScreen(){
    const startEl = document.getElementById("start");
    if(startEl){
      container.classList.add("start-hidden");
      
      const startBtn = document.getElementById("btnStart");
      if(startBtn){
        startBtn.addEventListener("click", () => {
          container.classList.remove("start-hidden");
        });
      }
      
      // Observer caso o elemento #start seja removido por script
